...
const Button = ({ text, type, color = 'purple', loading, onclick }) => {
  ...
  const classButtonBase = `focus:outline-none text-white focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 mb-5 `;
  ...
  if (color === 'indigo') {
    classColor =
      'bg-indigo-400 hover:bg-indigo-500  focus:ring-indigo-300    dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-900';
  }

  if (color === 'green') {
    classColor =
      'bg-green-500 hover:bg-green-700  focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-900';
  }
